...
error_invalid = lambda i: {'status':'failed','token_type':i,'message':'cookie invalid'}
...
def TokenEAAG(r, cookie):
    try:
        ...
        return(tok)
    except Exception as e: return(error_invalid('EAAG'))
...
def TokenEAAB(r, cookie):
    try:
        ...
        return(tok)
    except Exception as e: return(error_invalid('EAAB'))
...
def TokenEAAD(r, cookie):
    try:
        ...
        return(tok)
    except Exception as e: return(error_invalid('EAAD'))
...
def TokenEAAC(r, cookie):
    try:
        ...
        return(tok)
    except Exception as e: return(error_invalid('EAAC'))
...
def TokenEAAF(r, cookie):
    try:
        ...
        return(tok)
    except Exception as e: return(error_invalid('EAAF'))
...
def TokenEABB(r, cookie):
    try:
        ...
        return(tok)
    except Exception as e: return(error_invalid('EABB'))